				...
				<div class="inner" style="place-content: center">
					<section>
						<form action="" method="post" name="myForm" style="text-align: -webkit-center">
							...
							<div style="padding-top: 10em;font-size: 65%;">
								<a href="javascript:location.href='<%=cp %>/findidpw.action';" style="color: #00A2E8">아이디 / 비밀번호 찾기</a>
							</div>
							
							<ul class="actions" style="padding-top: 1em">
								<li><input type="button" value="로그인" class="special" onclick="sendIt();"/></li>
							</ul>
						</form>
					</section>
				</div>
