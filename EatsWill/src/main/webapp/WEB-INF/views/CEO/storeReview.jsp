...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  $(function(){
	  ...
	  // # :id   /   . :class
		$(window).load(function(){
			...
			//console.log("index : " + btnIdx);
			var count = parseInt("${reviewCount}"/"${numPerPage}");
			var pageNum = 1;
	        ...
	        $.ajax({
	            type:"post",
	            url:"<%=cp%>/ceoReviewArticle.action",
	            async: false,
	            data:params,
  ...
  $("#nextSee").click(function(){
		...
		var count = parseInt("${reviewCount}"/"${numPerPage}");
		var pageNum = addPage();
		console.log("reviewCount : " + count);
		var params = "shopCode=" + "${shopCode}";
	        params += "&shopName=" + "${shopdto.shopName }";
		...
		$.ajax({
			...
			success: function(args){ 
				...
				$("#ceoReviewArticle").append(args);
				
				if(pageNum  >= ("${reviewCount}"/"${numPerPage}")){
					$("#review").hide();
				}
			},
			error:function(e){
						...
						<div ng-show="active_tab == &quot;review&quot;" class="">
					      ...
					      <div class="star-point-wrap" >
					        <div class="inner" >
					          ...
					          <div style="width: 1000; padding-top: 5px;">
					             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;매&nbsp; 장&nbsp;&nbsp; 명 : ${shopdto.shopName }<br/>
					      ...
					      <div class="review-count">
					        <div>
					          리뷰 <strong class="ng-binding">${reviewCount }</strong>개
