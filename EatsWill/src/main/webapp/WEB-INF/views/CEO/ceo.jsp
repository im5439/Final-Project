		...
		<!-- 
 		...
 		-->
				...
				<div id="carousel-img" class="own-slide carousel slide"
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<a href="http://ygymall.yogiyo.co.kr/" target="mall"
								rel="noopener noreferrer"
								onclick="ga_event_tracker('SLIDE_BANNER_MALL', this, event)"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner2.png?v=3c43aea"
								alt="알뜰쇼핑 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/join/order_terminal/"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner5.gif"
								alt="사장님 주문접수 안내 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/join/tip/#tabs-5"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner4.png"
								alt="원산지 표시 안내 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/join/tip/#tabs-1"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner1.png"
								alt="우리동네 플러스 안내 배너"></a>
						</div>
						<div class="item">
							<a href="http://blog.yogiyo.co.kr/220901786014" target="_blank"
								rel="noopener noreferrer"
								onclick="ga_event_tracker('SLIDE_BANNER_REST', this, event)"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner3.png"
								alt="요기요 소식 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/external-square/" target="_blank"
								rel="noopener noreferrer"><img
								src="https://owner.yogiyo.co.kr/media/images/owners/slide-banner6.png"
								alt="요기요 포털 배너"></a>
						</div>
					</div>
					<a class="carousel-left carousel-control" href="#carousel-img"
						role="button" data-slide="prev" style="display: none;">&lt;</a> <a
						class="carousel-right carousel-control" href="#carousel-img"
						role="button" data-slide="next" style="display: none;">&gt;</a>
				</div>
						...
						<div class="own-login">
							...
							<div class="status-logout">
								<form method="POST" action="" name="myForm">
									...
									<div>
										<input type="text" class="inp-txt" id="ceoId" name="ceoId"
											placeholder="아이디 입력">
									</div>

									<div>
										<input type="password" class="inp-txt pwd" id="ceoPw"
											name="ceoPw" placeholder="비밀번호 입력">
									</div>

									<div class="id_pw_opt">
										<label> <input type="checkbox" name="save_id"
											id="save_id"> 아이디 저장
										</label> <a href="/owner/registration/1/">아이디/비밀번호 찾기</a>
									</div>
			...
			<ul class="info clearfix">
				<li class="n1"><a href="/owner/join/process/"
					onclick="ga_event_tracker('BOTTOM_BANNER_PROCESS', this, event)">요기요
						입점신청하기</a></li>
				<li class="n2"><a href="/owner/mall/sso_url/redirect/"
					onclick="ga_event_tracker('BOTTOM_BANNER_TERMINAL', this, event)">요기요
						알뜰쇼핑 바로가기</a></li>
				<li class="n4"><a href="/owner/terms/verification/">요기요
						이용약관 동의하기</a></li>
			</ul>

			<div class="sms-app-down">
				<div class="sms">
					<strong><em>SMS</em>로 사장님 앱 다운받기</strong> 휴대번호를 입력하시고 전송하기 버튼을
					누르시면, 다운받을 주소를 휴대폰으로 전송해드립니다.
					...
					<label for="chk"><input type="checkbox" name="agree"
						id="chk">SMS 발송을 위한 휴대폰번호 수집에 동의합니다.</label>
					<ul>
				...
				<div class="qrcode">
					<strong><em>QR코드</em> 스캔하기</strong>
					<p>
						스마트폰으로 QR코드를<br>스캔하면 앱 설치페이지로<br>이동됩니다.
					</p>
				</div>
			</div>
		</div>
