...
<meta name="description"
	content="잇츠윌 사장님 전용 사이트, 주문확인, 업소관리, 알뜰쇼핑, 청구서확인 등 사장님을 위한 다양한 정보 제공.">
		...
		<!-- 
 		...
 		-->
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<a href="http://ygymall.yogiyo.co.kr/" target="mall"
								...
								src="/eatswill/resources/img/ceoslide3.png"
								alt="사장님 주문접수 안내 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/join/order_terminal/"><img
								src="/eatswill/resources/img/ceoslide1.png"
								alt="원산지 표시 안내 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/join/tip/#tabs-5"><img
								src="/eatswill/resources/img/ceoslide5.png"
								alt="위생"></a>
						</div>
						<div class="item">
							<a href="http://blog.yogiyo.co.kr/220901786014" target="_blank"
								...
								src="/eatswill/resources/img/ceoslide4.png"
								alt="잇츠윌 소식 배너"></a>
						</div>
						<div class="item">
							<a href="/owner/external-square/" target="_blank"
								rel="noopener noreferrer"><img
								src="/eatswill/resources/img/ceoslide2.png"
								alt="잇츠윌 포털 배너"></a>
						</div>
					</div>
					...
					<c:when test="${empty sessionScope.ceoInfo.ceoId }">
						<div class="own-login">
							...
							<div class="status-logout">
								...
								<p class="txt">
									처음 방문하시는 사장님은 회원가입 후<br> 매장관리를 통해 입점을 완료해주세요.
								</p>
							</div>
						...
						<div class="own-login">
							...
							<div class="status-logout" style="border: 1px solid #cccccc;">
								<form method="POST" action="" name="myForm">
									...
									<br />
									<div style="padding-left: 50px;">주문확인 : <span style="color: #ff55ff">${orderChk }</span><c:if test="${orderChk > 0 }"> <img src="/eatswill/resources/img/New_icons_10.gif" style="display: inline; padding-left: 10;"/></c:if></div>
									<br />
			...
			<div class="sms-app-down">
				<div class="sms">
					<strong><em>SMS</em>로 사장님 앱 다운받기 곧 출시예정!</strong> 휴대번호를 입력하시고 전송하기 버튼을
				...
				<div class="qrcode">
					<strong><em>QR코드</em> 스캔하기 곧 출시예정!</strong>
					<p>
