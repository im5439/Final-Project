...
<body style="height: auto;">
	...
	<div class="own-container" style="padding-bottom: 0; overflow: auto;">
		<div class="own-main" style="margin-bottom: 80;">
		<%-- 
 		...
 		--%>
			<div class="mid clearfix" style="margin: 0;">
                            ...
                            <div class="table-responsive-xl">
                                <table class="table text-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="font-weight-semi-bold border-top-0 py-2">매장상태</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3" style="text-align-last: center;"> ${dto.codeName } </td>
                                        <td class="py-3">
                                            <span class="badge badge-pill badge-warning" style="text-align-last: center;">영업중</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <div class="position-relative">
                                            	<div style="font-size: 12">주문확인 : <span style="color: ff0000">${dto.osCount100 }</span><c:if test="${dto.osCount100 > 0 }"> <img src="/eatswill/resources/img/New_icons_10.gif" style="display: inline;"/></c:if></div>
                                            	<div style="font-size: 12">준비중&nbsp;&nbsp;&nbsp; : <span style="color: 0066ff">${dto.osCount200 }</span></div>
												<!-- 
												<div><span class="badge badge-pill badge-danger" style="background-color: #00ff33;'">주문확인</span></div>
												<div><span class="badge badge-pill badge-danger" style="background-color: #ff0033;'">주문취소</span></div>
												 -->
