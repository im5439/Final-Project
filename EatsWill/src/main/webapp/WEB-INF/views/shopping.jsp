...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="/media/images/owners/ygyshop_ios_57x57.png">
    <link rel="apple-touch-icon-precomposed" href="/media/images/owners/ygyshop_ios_72x72.png" sizes="72x72">
    <link rel="apple-touch-icon-precomposed" href="/media/images/owners/ygyshop_ios_114x114.png" sizes="114x114">
    <link rel="apple-touch-icon-precomposed" href="/media/images/owners/ygyshop_ios_144x144.png" sizes="144x144">
    ...
    <link rel="stylesheet" type="text/css" href="/media/css/jquery-ui-1.10.3.min.css" />
    <link rel="stylesheet" type="text/css" href="/media/owners/css/owners_new.css?v=f4db3dc" />
    <!-- <link href="/media/compressed/owners_page_base.rffe6aa724bb156908393fab4f615e785.css" rel="stylesheet" type="text/css" /> -->
...
<body>
  ...
  <div class="rd-wrapper contact-wrapper">
    ...
    <form class="form-horizontal form-signin" method="POST" action="/owner/registration/1/">
...
<div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="company_number" id="id_company_number" />
...
<div class="control-group">
    ...
    <script type="text/javascript" src="/media/owners/js/soundmanager2.js?v=f4db3dc"></script>
