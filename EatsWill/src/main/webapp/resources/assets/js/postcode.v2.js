(function() {
    ...
    window.daum = window.daum || {},
        function(a) {
            a.postcode = {}, a.postcode.version = "200421", a.postcode.load = function(a) {
                a && "function" == typeof a && a()
            }
        }(window.daum), "object" != typeof JSON && (JSON = {}),
        function() {
            "use strict";
    ...
    postcodeUtils.param = function(a) {
        ...
        for (var b = ["version/7", "version/8", "version/9", "version/10", "version/11", "version/12", "version/13", "version/14", "version/15"], c = 0, d = 0, e = b.length; e > d; d++) - 1 === a.indexOf(b[d]) && c++;
    ...
    ! function(a, b, c, d, e) {
        ...
        a.frame = function() {
            ...
            function l(b, c, d, e) {
                ...
                f.document.write(a(d)), h.setFrameStyle(f.document.getElementsByTagName("html")[0], f.document.getElementsByTagName("body")[0]), f.document.close(), j.setReady(f, function(a, i) {
                    if ("reload" === a) {
                        if (b.focus(), f && f.document) {
                            var k = f.document.getElementById(j.getId("viewerFrame", d.viewerNo));
                            k && k.focus()
                        }
                    } else "search" === a ? d.onSearch !== g.EMPTY_FUNCTION && d.onSearch(i) : "resize" === a ? d.onResize !== g.EMPTY_FUNCTION && (d.onResize(i), h.adjustLowIE(f, b, c, j.getId("viewerFrame", d.viewerNo), i.width, i.height)) : "done" === a && d.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() {
